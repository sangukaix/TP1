...
label var eyedoctor  "Vision Tested by Eye Doctor"
...
label var videophone  "Virtual Health Care Visits"
...
label var moves  "Number of Times Child Has Moved"
...
label define birth_mo_lab  1  "January"
    ...
    label define birth_mo_lab  10  "October", add
    label define birth_mo_lab  11  "November", add
    label define birth_mo_lab  12  "December", add
...
label define drawaface_lab  1  "This child cannot draw a face with eyes and a mouth"
...
label define liveusa_mo_lab  1  "0 to 2 months"
    label define liveusa_mo_lab  4  "3 to 5 months", add
    label define liveusa_mo_lab  7  "6 to 8 months", add
    label define liveusa_mo_lab  10  "9 to 11 months", add
    label define liveusa_mo_lab  .m "No valid response", add
...
label define moves_lab  1  "0 times"
    label define moves_lab  2  "1 time", add
    label define moves_lab  3  "2 or more times", add
    label define moves_lab  .m "No valid response", add
    label define moves_lab  .n "Not in universe", add
    label define moves_lab  .l "Logical skip", add
    label define moves_lab  .d "Suppressed for confidentiality", add
cap label values moves moves_lab
...
label define wgtconc_lab  1  "Yes, it's too high"
    ...
    label define wgtconc_lab  3  "No, I am not concerned", add
